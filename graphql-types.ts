...
export type FileFieldsEnum =
  ...
  | 'childrenMdx___frontmatter___product'
  | 'childrenMdx___frontmatter___category'
  | 'childrenMdx___frontmatter___sort'
  ...
  | 'childMdx___frontmatter___product'
  | 'childMdx___frontmatter___category'
  | 'childMdx___frontmatter___sort'
...
export type NavigationQuery = { signaturesPages: { edges: Array<{ node: { __typename: 'Mdx', id: string, slug?: string | null | undefined, frontmatter?: { title: string, category?: string | null | undefined } | null | undefined } }> } };
