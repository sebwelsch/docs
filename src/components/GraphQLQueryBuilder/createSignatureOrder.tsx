...
import { CreateSignatureOrderInput, DocumentInput, DocumentStorageMode, Language } from "../../../graphql-signatures-types";
      ...
      <div className="mb-4 grid grid-cols-3 gap-4">
        ...
        <div>
          ...
          <input
            ...
            onChange={(event) => setInput(input => ({...input, maxSignatories: parseInt(event.target.value, 10)}))}
          />
        </div>
        <div>
          ...
          <input
            ...
            onChange={(event) => setInput(input => ({...input, expiresInDays: parseInt(event.target.value, 10)}))}
          />
      ...
      <div className="mb-4 grid grid-cols-4 gap-4">
        <div>
          ...
          <input
            ...
            onChange={(event) => setUI(ui => ({...ui, signatoryRedirectUri: event.target.value}))}
          />
        </div>
        <div>
          ...
          <select
            ...
            onChange={(event) => setUI(ui => ({...ui, language: event.target.value as Language}))}
          >
