...
All eID services support user authentication. With Criipto Verify, you integrate using _OpenID Connect_ (aka OIDC). For a general overview of how OIDC works with Criipto Verify, see [Using OIDC](/verify/getting-started/oidc-intro).
