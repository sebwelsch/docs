...
sort: 1
title: Node.js
subtitle: Integrate Idura Signatures with Node.js to sign PDFs using MitID, Swedish BankID, Norwegian BankId or other eIDs.
---

This guide shows you how to use implement Idura Signatures in Node.js to sign
PAdeS-LTA documents using MitID, BankID or any other eID supported by Idura.
...
More [Node.js examples](/signatures/graphql/examples/) are provided for all the options supported by the Idura Signatures API.
