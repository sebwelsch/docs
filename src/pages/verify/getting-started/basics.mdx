...
<Highlight icon="info">
  ...
  Identity sources are already configured for test when you create a tenant. To be able to use an Identity Source in production you will - in most cases - have to enter into some sort of formal agreement with the provider of the particular type of e-ID.
  ...
  More detail on the formalities and process can be found in the section about [e-IDs](/verify/e-ids/).
