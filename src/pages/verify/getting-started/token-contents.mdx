...
sort: 3
title: JWT payloads pr. e-ID type
subtitle: Examples of JWT payloads for select e-ID's
---
import Layout from '../../../layouts/mdx';

export default Layout;

Below you will find the structure and example content for the JSON Web Tokens, the ID tokens, returned when signing in with each of the supported e-ID types.
