...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>`client_id`</td>
      <td>
        Your application's Client ID. You can find this value in the Idura Verify UI in the
    ...
    <tr>
      ...
      <td>
        ...
        Specification](https://tools.ietf.org/html/rfc6749#section-3.1.2), Idura removes
