...
4. Go to the **Domains** tab and set up a production domain.
   - Note that if you choose a domain that ends with something other than `criipto.id`, we recommend going with the Idura-managed option ("Managed SSL certificate") for SSL certificate.
