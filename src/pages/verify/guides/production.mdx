...
2. Next, you must acquire a production certificate for the e-ID provider(s) you wish to use in production. More on how to do that [can be found here](/verify/e-ids).
