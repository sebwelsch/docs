...
You can create a new or use an existing application from [Criipto Verify](https://manage.criipto.id/applications), just copy relevant values to fields below.
