...
You enable and disable `SSO` per DNS domain through the management dashboard for Idura Verify. Go to the `Domains` tab on [dashboard.criipto.com](https://dashboard.criipto.com/domains) and click on the domain you choose for SSO. The following options are available:
