...
You can see a preview of the dialogs in the `Identity Services` tab for your tenant in the management dashboard on [manage.criipto.id](https://manage.criipto.id/styling) - such as the ones for SE BankID:

<img src={previews} alt="Previews" />

Each e-ID method supports a specific set of languages - see [UI Language](/verify/guides/choose-language) for details. You can change the language used to generate the previews in the dropdown.
...
<img src={customStyling} alt="Custom Styling" />
