...
You can see a preview of the dialogs in the `Identity Services` tab for your tenant in the management dashboard on [dashboard.criipto.com](https://dashboard.criipto.com/styling) - such as the ones for SE BankID:
