...
1. [Register your application in Idura Verify](#register-your-application-in-criipto-verify)
2. [Configure OAuth2 Code Flow](#configure-the-oauth2-code-flow)
3. [Configure your application to use Idura Verify](#configure-your-application-to-use-criipto-verify)
