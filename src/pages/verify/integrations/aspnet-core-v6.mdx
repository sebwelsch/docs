...
After you signed up for Idura Verify, you must [register an application](https://dashboard.criipto.com/applications/add) before you can actually try logging in with any eID.
