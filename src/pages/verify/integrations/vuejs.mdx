...
After you signed up for Idura Verify, you must [register an application](https://dashboard.criipto.com/applications/add) before you can try logging in with any eID.
...
- `domain (required, string)`: The domain your Idura Application belongs to, such as `example.criipto.id`.
