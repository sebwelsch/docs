...
3. Get a BankID for test. _You have to log in at the <a href="https://demo.bankid.com/" target="_blank">Demo bank website</a> to create a test user. If you don't have a production BankID, choose the **Personal code** option to log in. The code will be sent to you by email._
