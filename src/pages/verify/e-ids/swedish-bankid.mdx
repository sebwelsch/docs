...
# Replace `YOUR_DOMAIN.criipto.id` with your Idura domain
...
After Idura has received the filled out form, we send it to Swedbank where it will be reviewed and typically approved within a few business days.
