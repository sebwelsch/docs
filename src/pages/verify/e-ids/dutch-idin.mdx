...
Developers can specify the user profile per authorize request by providing the `login_hint` parameter with the required value. Alternatively, the value can be supplied in the `scope` parameter.
...
Add `login_hint=scope:idin:full-id` to the authorize request to get this profile:
...
Add `login_hint=scope:idin:re-id` to the authorize request to get this profile:
...
Add `login_hint=scope:idin:safe-login` to the authorize request to get this profile:
...
Add `login_hint=scope:idin:age-verification` to the authorize request to get this profile:
