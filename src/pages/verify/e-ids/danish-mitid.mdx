...
If you company is *not* registered in Denmark, meaning you don't have MitID Erhverv, please send a request for MitID onboarding to [support@criipto.com](mailto:support@criipto.com).
