...
- The person applying must have a MitID employee signature from the company in question, a socalled "medarbejdersignatur"
...
3. A user with a MitID employee signature, a socalled "medarbejdersignatur" must click the button and sign in.
...
5. The information is sent to Nets who will setup your MitID Domain.
...
If you company is *not* registered in Denmark, meaning you don't have MitID employee signatures ("medarbejdersignatur"), please send a request for MitID onboarding to [support@criipto.com](mailto:support@criipto.com).
