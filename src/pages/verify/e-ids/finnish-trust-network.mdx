...
A legal agreement with Criipto is mandatory to access FTN. You can request one by filling out the <a href="https://dashboard.criipto.com/providers/FI_TELIA/contract" target="_blank"> FTN Production Agreement form </a> in your Criipto Dashboard. **The process typically takes 2-3 business days**.
