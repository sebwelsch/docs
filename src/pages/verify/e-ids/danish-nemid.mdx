...
You must enter a PID-CPR agreement with NETS in conjuction to your NemID TU agreement, and enter your SPID in the "SPID for PID/CPR service" field in the [management dashboard](https://manage.criipto.id/providers/DK_NEMID).
