...
You will need a set of API credentials to execute queries, please see [Registering your application](/document-signatures/getting-started/register-application/)
