...
import { ExamplesCreateSignatureOrderMutationVariables, DocumentStorageMode } from "../../../../../signatures-graphql-types";
...
export const variables = () : ExamplesCreateSignatureOrderMutationVariables => ({
  input: {
    documents: [
      {
        pdf: {
