...
import {query as addSignatories, Explorer as AddSignatoriesExplorer} from '../../../examples/addSignatories.graphql';
...
<CodeBlock text={addSignatories} />
<AddSignatoriesExplorer />
