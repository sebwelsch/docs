...
import * as addSignatoryEvidenceValidationExample from '../../../examples/addSignatoryEvidenceValidation.graphql';
...
import * as addSignatoryScopedExample from '../../../examples/addSignatoryScoped.graphql';

By using the `documents` input array for `addSignatory` you can limit what documents a signatory will be shown.

<GraphQLExample example={addSignatoryScopedExample} />

### Preapproval

import * as addSignatoryPreapprovedExample from '../../../examples/addSignatoryPreapproved.graphql';
